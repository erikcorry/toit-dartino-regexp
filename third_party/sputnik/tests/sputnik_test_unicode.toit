...
main:
  ...
  expected = ["å"]
  check m expected
  // Rejected for unicode: var __executed = /e\b/.exec("pilot\nsoviet robot\topenoffic\u0065");
  // S15.10.2.6_A1_T4.js
  // Rejected 3: var __executed = /[^e]$/mg.exec("pairs\nmakes\tdouble");
  // Rejected for unicode: var __executed = /\d{3}|[a-z]{4}/.test("2, 12 and 23 AND 0.00.1");
  ...
  expected = ["b", ""]
  check m expected
  // Rejected for unicode: var __executed = /\b\w{5}\b/.exec("pilot\nsoviet robot\topenoffice");
  // Rejected for unicode: var __executed = /\w{3}\d?/.exec("CE\uFFFFL\uFFDDbox127");
  // S15.10.2.3_A1_T9.js
  re = RegExp "(?:åb|çd)+|éf" --case_sensitive=false --multiline=false
  ...
  expect_equals null m
  // Rejected for unicode: var __executed = /q[ax-zb](?=\s+)/.exec("tqaqy ");
  // S15.10.2.7_A3_T4.js
  ...
  expected = ["bbbbbbb"]
  check m expected
  // Rejected for unicode: var __executed = /[d-h]+/.exec("abcdefghijkl");
  // Rejected for unicode: var __executed = /^([a-z]+)*[a-z]$/.exec(__string);
  ...
  expect_equals null m
  // Rejected for unicode: var __executed = /[^\[\b\]]+/.exec("abcdef");
  // S15.10.2.6_A2_T1.js
  ...
  expected = ["åbçdé"]
  check m expected
  // Rejected for unicode: var __executed = /([Jj]ava([Ss]cript)?)\sis\s(fun\w*)/.exec("Developing with Java is fun, try it");
  // Rejected for unicode: var __executed = /[a-z]+\d+/.exec("__abc123.0");
  // S15.10.2.7_A4_T2.js
  re = RegExp """[^"]*""" --case_sensitive=true --multiline=false
  ...
  expected = ["jåvå", null]
  check m expected
  // Rejected for unicode: var __executed = /^p[a-z]/.exec("pairs\nmakes\tdouble\npesos");
  // S15.10.2.7_A5_T1.js
  re = RegExp "jåvå(sçrïpt)?" --case_sensitive=true --multiline=false
  ...
  expected = ["b", ""]
  check m expected
  // Rejected for unicode: var __executed = /r\b/.test("pilot\nsoviet robot\topenoffice");
  // Rejected for unicode: var __executed = /\brobot\b/.exec("pilot\nsoviet robot\topenoffice");
  // Rejected for unicode: var __executed = /Java(?!Script)([A-Z]\w*)/.exec("using of JavaBeans technology");
  ...
  expected = [".", "."]
  check m expected
  // Rejected for unicode: var __executed = /[a-c\d]+/.exec("\n\n\abc324234\n");
  // Rejected for unicode: var __executed = /\B[^z]{4}\B/.exec("devil arise\tforzzx\nevils");
  ...
  expected = ["1984"]
  check m expected
  // Rejected for unicode: var __executed = /\bso/.exec("pilot\nsoviet robot\topenoffice");
  // Rejected for unicode: var __executed = /\bro/.exec("pilot\nsoviet robot\topenoffice");
  // S15.10.2.8_A3_T5.js
  re = RegExp "å(bç)d(éf)ġ" --case_sensitive=true --multiline=false
  m = re.first_matching "åbçdéfġ"
  expected = ["åbçdéfġ", "bç", "éf"]
  check m expected
  // Rejected for unicode: var __executed = /\bp/.exec("pilot\nsoviet robot\topenoffice");
  // Rejected for unicode: var __executed = /q[ax-zb](?=\s+)/.exec("tqa\t  qy ");
  // S15.10.2.7_A3_T1.js
  re = RegExp "\\s+jåvå\\s+" --case_sensitive=true --multiline=false
  ...
  expected = ["ååbçdåå", "åå"]
  check m expected
  // Rejected for unicode: var __executed = /[a-z][^1-9][a-z]/.exec("a1b  b2c  c3d  def  f4g");
  // S15.10.2.7_A5_T11.js
  re = RegExp "\\??\\??\\??\\??\\??" --case_sensitive=true --multiline=false
  m = re.first_matching "?????"
  expected = ["?????"]
  check m expected
  // Rejected for unicode: var __executed = /\d{3}|[a-z]{4}/.exec("2, 12 and 234 AND of course repeat 12");
  // Rejected for unicode: var __executed = /[a-z]+/ig.exec(__string);
  // Rejected for unicode: var __executed = /([Jj]ava([Ss]cript)?)\sis\s(fun\w*)/.exec("Learning javaScript is funny, really");
  // S15.10.2.7_A5_T7.js
  ...
  re = RegExp ".+" --case_sensitive=true --multiline=false
  // Rejected input (__string);
  // Rejected for unicode: var __executed = /\B\w\B/.exec("devils arise\tfor\nrevil");
  ...
  expected = [""]
  check m expected
  // Rejected for unicode: var __executed = /[a-z]+\d+/.exec("x 2 ff 55 x2 as1 z12 abc12.0");
  // S15.10.2.6_A1_T2.js
  re = RegExp "é\$" --case_sensitive=true --multiline=false
  m = re.first_matching "påïrs\nmåkés\tdøübłé"
  expected = ["é"]
  ...
  expected = ["xxxxxxx"]
  check m expected
  // Rejected for unicode: var __executed = /[^\[\b\]]+/.exec("abc\bdef");
  // S15.10.2.6_A6_T3.js
  re = RegExp "^.*?(:|\$)" --case_sensitive=true --multiline=false
  m = re.first_matching "Héłłø: Wørłd"
  expected = ["Héłłø:", ":"]
  check m expected
  // Rejected for unicode: var __executed = /([xu]\d{2}([A-H]{2})?)\1/.exec("x09x12x01x01u00FFu00FFx04x04x23");
  // S15.10.2.7_A6_T3.js
  ...
  re = RegExp "(å)?å" --case_sensitive=true --multiline=false
  // Rejected input (__string);
  // Rejected for unicode: var __executed = /\Bevil\B/.exec("devils arise\tfor\nevil");
  // S15.10.2.6_A6_T1.js
  re = RegExp "^.*?\$" --case_sensitive=true --multiline=false
  m = re.first_matching "Héłłø Wørłd"
  ...
  expected = ["jåvå", null]
  check m expected
  // Rejected for unicode: var __executed = /\bop/.exec("pilot\nsoviet robot\topenoffice");
  // S15.10.2.3_A1_T2.js
  ...
  expected = ["å"]
  check m expected
  // Rejected for unicode: var __executed = /^(([a-z]+)*[a-z]\.)+[a-z]{2,}$/.exec(__string);
  ...
  m = re.first_matching "ÅÉKFÇD"
  expect_equals null m
  // Rejected for unicode: var __executed = /\B\w{4}\B/.exec("devil arise\tforzzx\nevils");
  ...
  expected = ["bbç"]
  check m expected
  // Rejected for unicode: var __executed = /\d{3}|[a-z]{4}/.exec("2, 12 and of course repeat 12");
  // S15.10.2.7_A4_T4.js
  re = RegExp """[^"]*""" --case_sensitive=true --multiline=false
  m = re.first_matching "åłïçé \"swéép\": \"døn't\""
  expected = ["åłïçé "]
  check m expected
  // Rejected for unicode: var __executed = /([xu]\d{2}([A-H]{2})?)\1/.exec("x09x12x01x05u00FFu00FFx04x04x23");
  // S15.10.2.8_A3_T4.js
  re = RegExp "(åbç)" --case_sensitive=true --multiline=false
  m = re.first_matching "åbç"
  expected = ["åbç", "åbç"]
  check m expected
  // Rejected for unicode: var __executed = /^p[b-z]/m.exec("pairs\nmakes\tdouble\npesos");
  ...
  expected = ["6dé"]
  check m expected
  // Rejected for unicode: var __executed = /\b(\w+) \1\b/.exec("do you listen the the band");
  ...
  expected = ["åłïçé "]
  check m expected
  // Rejected for unicode: var __executed = /a[a-z]{2,4}?/.exec("abcdefghi");
  // S15.10.2.7_A4_T21.js
  re = RegExp "[xyz]*1" --case_sensitive=true --multiline=false
  m = re.first_matching "å0.b2.ç3"
  expect_equals null m
  // Rejected for unicode: var __executed = /q[ax-zb](?=\s+)/.exec("qYqy ");
  ...
  expected = ["123123", "123"]
  check m expected
  // Rejected for unicode: var __executed = /op\b/.test("pilot\nsoviet robot\topenoffice");
  ...
  m = re.first_matching "åbç"
  expect_equals null m
  // Rejected for unicode: var __executed = /Java(?!Script)([A-Z]\w*)/.exec("JavaScr oops ipt ");
  // S15.10.2.7_A4_T8.js
  re = RegExp """["'][^"']*["']""" --case_sensitive=true --multiline=false
  m = re.first_matching "åłïçé çrïés øüt: døn't"
  expect_equals null m
  // S15.10.2.6_A1_T5.js
  // Rejected 3: var __executed = /es$/mg.exec("pairs\nmakes\tdoubl\u0065s");
  // Rejected for unicode: var __executed = /^([a-z]+)*[a-z]$/.exec(__string);
  // S15.10.2.8_A2_T8.js
  re = RegExp "(\\.(?!çøm|ørġ)|/)" --case_sensitive=true --multiline=false
  m = re.first_matching "åh.çøm"
  expect_equals null m
  // Rejected for unicode: var __executed = /([Jj]ava([Ss]cript)?)\sis\s(fun\w*)/.test("Developing with JavaScript is dangerous, do not try it without assistance");
  // Rejected for unicode: var __executed = /^([a-z]+)*[a-z]$/.exec(__string);
  // Rejected for unicode: var __executed = /\B\B\B\B\B\Bbot\b\b\b\b\b\b\b/.exec("robot wall-e");
  // S15.10.2.8_A3_T7.js
  ...
  expected = ["123"]
  check m expected
  // Rejected for unicode: var __executed = /[^a-z]{4}/.exec("abc#$%def%&*@ghi");
  // Rejected for unicode: var __executed = /[^"]*/.exec('"beast"-nickname');
  // S15.10.2.8_A1_T5.js
  re = RegExp "[Jj]åvå([Ss]çrïpt)?(?=\\:)" --case_sensitive=true --multiline=false
  ...
  expected = ["åbç"]
  check m expected
  // Rejected for unicode: var __executed = /so\b/.test("pilot\nsoviet robot\topenoffice");
  // S15.10.2.8_A4_T1.js
  ...
  expected = ["ÇD"]
  check m expected
  // Rejected for unicode: var __executed = /ot\b/.exec("pilot\nsoviet robot\topenoffice");
  // S15.10.2.7_A1_T4.js
  re = RegExp "\\d{2,4}" --case_sensitive=true --multiline=false
  m = re.first_matching "thé Fåhrénhéït 451 bøøk"
  expected = ["451"]
  check m expected
  // Rejected for unicode: var __executed = /c[\b]{3}d/.exec("abc\b\b\bdef");
  // Rejected for unicode: var __executed = /a[^b-z]\s+/.exec("ab an az aY n");
  // S15.10.2.8_A4_T3.js
  re = RegExp ".*å.*" --case_sensitive=true --multiline=false
  // Rejected input (__string);
  // Rejected for unicode: var __executed = /[a-z]+(\d+)/.exec("__abc123.0");
  ...
  // Rejected for unicode: var __executed = /a[a-z]{2,4}/.exec("abcdefghi");
  // Rejected for unicode: var __executed = /[a-z]+(\d+)/.exec("x 2 ff 55 x2 as1 z12 abc12.0");
  // Rejected for unicode: var __executed = /[a-z]+/.exec(__string);
  // S15.10.2.5_A1_T4.js
  ...
  expected = ["*&\$"]
  check m expected
  // Rejected for unicode: var __executed = /Java(?!Script)([A-Z]\w*)/.test("i'm a JavaScripter ");
  // S15.10.2.7_A5_T5.js
  ...
  expect_equals null m
  // Rejected for unicode: var __executed = /\bot/.test("pilot\nsoviet robot\topenoffice");
  // Rejected for unicode: var __executed = /[^o]t\b/i.exec("pilOt\nsoviet robot\topenoffice");
  // S15.10.2.6_A5_T1.js
  ...
  expected = ["çdddd"]
  check m expected
  // Rejected for unicode: var __executed = /[^o]t\b/.exec("pilOt\nsoviet robot\topenoffice");
  // S15.10.2.8_A3_T11.js
  re = RegExp "å(..(..)..)" --case_sensitive=true --multiline=false
  m = re.first_matching "åbçdéfġh"
  expected = ["åbçdéfġ", "bçdéfġ", "dé"]
  check m expected
  // Rejected for unicode: var __executed = /[f-z]e\B/.exec("devils arise\tfor\nrevil");
  // Rejected for unicode: var __executed = /[^\b]+/g.exec("easy\bto\u0008ride");
  // S15.10.2.8_A4_T8.js
  re = RegExp ".+" --case_sensitive=true --multiline=false
  // Rejected input (__string);
  // S15.10.2.8_A2_T1.js
  ...
  m = re.first_matching "påïrs\nmåkés\tdøübłé"
  expect_equals null m
  // Rejected for unicode: var __executed = /\Bo\B/i.exec("devils arise\tfOr\nrevil");
  // S15.10.2.8_A1_T1.js
  re = RegExp "(?=(å+))" --case_sensitive=true --multiline=false
  ...
  expected = ["/", "/"]
  check m expected
  // Rejected for unicode: var __executed = /Java(?!Script)([A-Z]\w*)/.test("using of Java language");
  // S15.10.2.7_A4_T3.js
  re = RegExp """[^"]*""" --case_sensitive=true --multiline=false
  ...
  expected = ["tést"]
  check m expected
  // Rejected for unicode: var __executed = /\w\B/.exec("devils arise\tfor\nrevil");
  // Rejected for unicode: var __executed = /\B\w/.exec("devils arise\tfor\nrevil");
  // Rejected for unicode: var __executed = /\be/.test("pilot\nsoviet robot\topenoffic\u0065");
  // Rejected for unicode: var __executed = /\w{3}\d?/.exec("CELL\uFFDDbox127");
